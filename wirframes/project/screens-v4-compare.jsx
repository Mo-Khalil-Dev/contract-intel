...
function AddContractPicker({ candidates, onPick, onClose }) {
  return (
    ...
    >
      ...
      {candidates.length === 0 ? (
        <div style={{ padding: '20px', textAlign: 'center', fontSize: 12, color: W.textMute }}>
    ...
    <PageShell
      ...
      actions={
        <>
          ...
          <WBtn variant="secondary" small disabled={!canCompare}>
            🖶 Print
          </WBtn>
        </>
      }
          ...
          {selected.map((c) => (
            ...
            >
              ...
              <button
                ...
                style={{
                  background: selected.length <= 2 ? 'transparent' : W.bg,
                  border: `1px solid ${W.border}`,
                  borderRadius: 3,
                  width: 20,
                  height: 20,
        ...
        {!canCompare && (
          <div
            style={{
              ...
              textAlign: 'center',
              background: W.surface,
              border: `1px dashed ${W.border2}`,
              borderRadius: 8,
            }}
          >
            <div style={{ fontSize: 32, marginBottom: 8, opacity: 0.5 }}>⇄</div>
            <div style={{ fontSize: 14, fontWeight: 700, color: W.text, marginBottom: 4 }}>
              Pick at least 2 contracts to compare
            </div>
            <div style={{ fontSize: 12, color: W.textSoft }}>
          ...
          <>
            ...
            {winner ? (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 12, color: W.textMid, lineHeight: 1.5 }}>
                    Leads on <strong style={{ color: W.green }}>{winner.better}</strong> comparable
                    terms
                    {winner.worse > 0 && (
                      <>
                        {' '}
                        against <strong style={{ color: W.red }}>{winner.worse}</strong> losses
                      </>
                    )}{' '}
                ...
                <WBtn small onClick={() => onSelectContract(winner.c.id)}>
                  Open contract →
                </WBtn>
              </div>
            ) : (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 13, fontWeight: 700, color: W.text, marginBottom: 2 }}>
                    No clear winner
                  </div>
                  <div style={{ fontSize: 12, color: W.textSoft }}>
                ...
                {selected.map((c, i) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        padding: '12px 14px',
                        borderRight: i < selected.length - 1 ? `1px solid ${W.border}` : 'none',
                        background: isWinner ? W.greenBg : W.bg,
                        position: 'relative',
                      }}
                    >
                      {isWinner && (
                    ...
                    {groupRows.map((row, ri) => (
                      <div
                        ...
                        style={{
                          ...
                          gridTemplateColumns: gridCols,
                          borderBottom:
                            ri < groupRows.length - 1 ? `1px solid ${W.border}` : 'none',
                        ...
                        {selected.map((c, ci) => (
                          <div
                            ...
                            style={{
                              padding: '8px 10px',
                              borderRight:
                                ci < selected.length - 1 ? `1px solid ${W.border}` : 'none',
                            }}
                          >
      ...
      {showExport && (
        <WModal title="Export Comparison Report" onClose={() => setShowExport(false)} width={460}>
          ...
          <div style={{ display: 'flex', gap: 7, justifyContent: 'flex-end' }}>
            <WBtn variant="secondary" small onClick={() => setShowExport(false)}>
              Cancel
            </WBtn>
            <WBtn small onClick={() => setShowExport(false)}>
              Generate Report
            </WBtn>
          </div>
        </WModal>
