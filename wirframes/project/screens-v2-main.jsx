  ...
  const pillBtn = (val, cur, set, label) => (
    <button
      ...
      style={{
        ...
        color: cur === val ? D.accent : D.textSoft,
        cursor: 'pointer',
      }}
    >
      {label}
      ...
      >
        <div style={{ flex: 1 }}>
          ...
          <p style={{ margin: '2px 0 0', fontSize: 12, color: D.textSoft }}>
            {filtered.length} contracts · {urgent} high risk
          </p>
        </div>
        {/* Quick stats */}
          ...
          {['grid', 'list'].map((v) => (
            <button
              ...
              style={{
                ...
                color: view === v ? D.accent : D.textSoft,
                cursor: 'pointer',
                fontSize: 14,
              }}
            >
              ...
              <tbody>
                {filtered.map((c, i) => (
                  <tr
                    ...
                    onMouseEnter={(e) => {
                      if (c.status === 'complete') e.currentTarget.style.background = D.surface2;
                    }}
                  ...
                  >
                    ...
                    <td style={{ padding: '10px 14px', color: D.textMid, fontSize: 12 }}>
                      {c.parties[0]}
                    </td>
                    <td
                      style={{
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          padding: '20px 24px',
          background: `linear-gradient(180deg, ${D.bg2} 0%, ${D.bg} 100%)`,
          borderBottom: `1px solid ${D.border}`,
          display: 'flex',
          alignItems: 'center',
          gap: 24,
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '24px' }}>
        ...
        {tab === 'overview' && (
          <div
            style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16, maxWidth: 1000 }}
          >
            {[
              {
                title: 'Parties',
                ...
                {notes.map((n) => (
                  ...
                  >
                    <div style={{ fontSize: 11, color: D.textSoft, marginBottom: 4 }}>
                      ...
                      {n.resolved && (
                        <span style={{ color: D.green, marginLeft: 8 }}>✓ Resolved</span>
                      )}
                    </div>
              ...
              .map((f) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      background: D.surface,
                      border: `1px solid ${isResolved ? D.border : fc + '33'}`,
                  ...
                  >
                    ...
                    >
                      ...
                      ></div>
                      <span style={{ flex: 1, fontWeight: 600, fontSize: 14, color: D.text }}>
                        {f.title}
                      </span>
                      {isResolved && (
                      ...
                      <span style={{ fontSize: 11, color: D.textMute }}>
                        Pg {f.page} §{f.section}
                      </span>
                      <span style={{ color: D.textMute, fontSize: 12 }}>
                        {isExpanded ? '▲' : '▼'}
                      </span>
                    </div>
                    {isExpanded && (
                      <div style={{ padding: '0 16px 14px', borderTop: `1px solid ${D.border}` }}>
                        ...
                        >
                          <span style={{ color: D.accent, fontWeight: 700 }}>Rec: </span>
                          {f.recommendation}
                        </div>
                        <div style={{ display: 'flex', gap: 8 }}>
                          <DBtn
        ...
        {tab === 'document' && (
          <div
            style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 16, maxWidth: 1000 }}
          >
            {/* PDF mock */}
            <div
              style={{
            ...
            >
              ...
              >
                ...
                <p>
                  ...
                  <strong style={{ color: '#e2e8f0' }}>{c.effectiveDate}</strong>, between{' '}
                  <strong style={{ color: '#e2e8f0' }}>{c.parties[0]}</strong> ("Vendor") and{' '}
                  <strong style={{ color: '#e2e8f0' }}>{c.parties[1]}</strong> ("Buyer").
                </p>
                <p style={{ marginTop: 14 }}>
                  <strong style={{ color: '#e2e8f0' }}>5. PAYMENT</strong>
                  <br />
                ...
                >
                  <strong style={{ color: D.orange }}>7. LIABILITY</strong>
                  <br />
                  <span
                    style={{
                  ...
                  >
                    Vendor's liability hereunder shall not be limited in any manner whatsoever, and
                    Buyer acknowledges that Vendor may face unlimited exposure...
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  <strong style={{ color: D.red }}>10. INDEMNIFICATION</strong>
                  <br />
                  <span
                    style={{
                  ...
                  >
                    Buyer shall indemnify and hold harmless Vendor from any IP infringement claims.
                    Vendor shall only indemnify Buyer for its own gross negligence...
                  </span>
                </div>
                <p style={{ marginTop: 14, color: '#475569', fontStyle: 'italic' }}>
                  [Pages 3–8 continue…]
                </p>
              </div>
              <div
              ...
              >
                <DBtn small variant="secondary">
                  ← Prev
                </DBtn>
                <span style={{ fontSize: 12, color: D.textSoft, padding: '5px 8px' }}>
                  Page 1 of 8
                </span>
                <DBtn small variant="secondary">
                  Next →
              ...
              >
                ...
                <div style={{ padding: 14 }}>
                  ...
                  >
                    ...
                    ></span>
                    <span style={{ fontSize: 11, fontWeight: 700, color: D.red }}>
                  ...
                  >
                    Negotiate to add: "Vendor liability shall not exceed two times the annual
                    contract value."
                  </div>
                  <div style={{ display: 'flex', gap: 6 }}>
                    <DBtn small variant="secondary" ex={{ flex: 1, justifyContent: 'center' }}>
                      Copy
                    </DBtn>
                    <DBtn
                      small
                      variant="primary"
                      ex={{ flex: 1, justifyContent: 'center' }}
          ...
          <div style={{ maxWidth: 680 }}>
            {[
              ...
              },
              {
                ...
                user: 'Sarah Chen',
                action: 'Flag Viewed',
                detail: 'Unlimited Liability (Red Flag)',
                color: D.orange,
              },
            ].map((e, i) => (
              <div
