...
function PortfolioScreen({ onSelectContract }) {
  ...
  const unlimitedLiability = complete.filter((c) =>
  ...
  const typeData = ['vendor', 'license', 'partnership', 'customer', 'lease', 'nda']
    .map((t) => ({
      label: t,
  ...
  const upcoming = RENEWALS.filter((r) => r.daysRemaining < 60).sort(
      ...
      <div style={{ padding: '20px 28px', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 12 }}>
          ...
          <StatCard
            ...
            value={avgRisk}
            sub="Out of 10.0"
            color={riskColor(parseFloat(avgRisk))}
            mono
          />
          <StatCard
            label="Red Flags"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
          ...
          >
            <h3 style={{ margin: '0 0 4px', fontSize: 13, fontWeight: 700, color: T.text }}>
              Risk Score Distribution
            </h3>
            <p style={{ margin: '0 0 16px', fontSize: 12, color: T.textSoft }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 20 }}>
              ...
              <tbody>
                {topRisks.map((c, i) => (
                  ...
                  >
                    ...
                    <td
                      style={{ padding: '9px 14px', fontWeight: 600, color: T.text, maxWidth: 200 }}
                    >
                      <div
                        style={{
                          overflow: 'hidden',
          ...
          >
            <h3 style={{ margin: '0 0 12px', fontSize: 13, fontWeight: 700, color: T.text }}>
              Liability Analysis
            </h3>
            {[
              ...
              { label: 'Capped at other amounts', count: 2, bar: 25, color: T.orange },
              {
                ...
                count: unlimitedLiability,
                bar: (unlimitedLiability / complete.length) * 100,
                color: T.red,
              },
            ].map((row, i) => (
            ...
            >
              ⚠ {unlimitedLiability} contract{unlimitedLiability !== 1 ? 's' : ''} with unlimited
              liability exposure — action required.
            </div>

            <h3 style={{ margin: '20px 0 10px', fontSize: 13, fontWeight: 700, color: T.text }}>
  ...
  return (
    <div style={{ flex: 1, background: T.bg, overflow: 'auto' }}>
      <PageHeader
        ...
        subtitle="Track upcoming contract renewals and notice periods"
      />
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 3,
                border: `1px solid ${T.border}`,
                background: filter === val ? T.navy : '#fff',
          ...
          {months.slice(0, 4).map(({ year: y, month: m, label }) => {
            ...
            return (
              ...
              >
                ...
                {renewals.length === 0 ? (
                  <div style={{ padding: '12px 16px', fontSize: 12, color: T.textMute }}>
                  ...
                  renewals.map((r) => (
                    <div
                      ...
                      onMouseEnter={(e) => {
                        if (selected !== r.id) e.currentTarget.style.background = '#f8fafc';
                      }}
                      onMouseLeave={(e) => {
                        if (selected !== r.id) e.currentTarget.style.background = '#fff';
                      }}
                    >
                      <div
                        style={{
                      ...
                      <div style={{ fontSize: 11, color: T.textSoft, marginTop: 3 }}>
                        {r.renewalDate} · {r.noticePeriod} notice · Risk{' '}
                        <span style={{ color: riskColor(r.riskScore), fontWeight: 700 }}>
                          {r.riskScore}
                        </span>
                      </div>
                    </div>
        ...
        <div style={{ position: 'sticky', top: 20, alignSelf: 'start' }}>
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            color: T.text,
                            fontFamily:
                              k.includes('Days') || k.includes('Score')
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              <Btn small variant="secondary" style={{ flex: 1, justifyContent: 'center' }}>
                Outlook
              </Btn>
              <Btn small variant="secondary" style={{ flex: 1, justifyContent: 'center' }}>
                Google Cal
  ...
  return (
    <div style={{ flex: 1, background: T.bg, overflow: 'auto' }}>
      <PageHeader
        ...
        subtitle="Manage standard contract templates for comparison"
          ...
          {['all', 'vendor', 'customer', 'partnership', 'license', 'nda'].map((t) => (
            <button
              ...
              style={{
                ...
                borderRadius: 3,
                border: `1px solid ${T.border}`,
                background: filterType === t ? T.navy : '#fff',
                color: filterType === t ? '#fff' : T.textMid,
                cursor: 'pointer',
                fontSize: 12,
                fontWeight: 600,
            ...
            <tbody>
              {filtered.map((t) => (
                <tr key={t.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                  ...
                  <td style={{ padding: '10px 16px', color: T.textSoft, fontSize: 12 }}>
                    {t.uploaded}
                  </td>
                  <td style={{ padding: '10px 16px' }}>
                    <div style={{ display: 'flex', gap: 6 }}>
    ...
    <div style={{ flex: 1, background: T.bg, overflow: 'auto' }}>
      ...
      <div style={{ padding: '24px 28px' }}>
                ...
                <tbody>
                  {members.map((m) => (
                    <tr key={m.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                      ...
                      <td style={{ padding: '10px 16px' }}>
                        {m.status === 'pending' ? (
                          <span style={{ color: T.orange, fontSize: 12, fontWeight: 600 }}>
                            ⏳ Pending
                          </span>
                        ) : (
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
                {[
                  ...
                  {
                    role: 'Reviewer',
                    perms: ['View all contracts', 'Add comments', 'Assign contracts'],
                    denied: ['Delete contracts', 'Manage team'],
                  },
                  {
                    role: 'Viewer',
                    perms: ['View all contracts'],
                    denied: ['Edit data', 'Add comments', 'Delete contracts'],
                  },
                ].map((r) => (
                  <div
                    key={r.role}
                  ...
                  >
                    ...
                    {r.perms.map((p) => (
                      <div key={p} style={{ fontSize: 12, color: T.green, marginBottom: 3 }}>
                        ✓ {p}
                      </div>
                    ))}
                    {r.denied.map((p) => (
                      <div key={p} style={{ fontSize: 12, color: T.textMute, marginBottom: 3 }}>
                        ✗ {p}
                      </div>
                    ))}
                  </div>
          ...
          <div style={{ maxWidth: 600 }}>
            ...
            >
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: 13, color: T.textSoft, marginTop: 2 }}>
                    £299/month · Up to 50 contracts/month
                  </div>
                </div>
              ...
              <div style={{ marginTop: 16, height: 6, background: T.bg, borderRadius: 3 }}>
                <div
                  style={{ width: '72%', height: '100%', background: T.blue, borderRadius: 3 }}
                ></div>
              </div>
                  ...
                  {[
                    {
                      ...
                      detail: 'Q1 2026 Outsourcing Review.pdf',
                      color: T.blue,
                    },
                    {
                      ts: '2026-04-14 10:05',
                      ...
                      detail: 'Unlimited Liability · Acme Vendor Agreement',
                      color: T.orange,
                    },
                    {
                      ts: '2026-04-11 14:22',
                      user: 'Sarah Chen',
                      action: 'Note Added',
                      detail: 'Acme Vendor Agreement 2024.pdf',
                      color: T.textMid,
                    },
                    {
                      ts: '2026-04-10 09:15',
                      ...
                      detail: 'Acme Vendor Agreement 2024.pdf · Score 8.5/10',
                      color: T.green,
                    },
                    {
                      ts: '2026-04-10 09:14',
                    ...
                    },
                    {
                      ...
                      detail: 'TechCo Software License 2023.pdf · PDF',
                      color: T.textMid,
                    },
                  ].map((e, i) => (
                    <tr key={i} style={{ borderTop: `1px solid ${T.border}` }}>
                      ...
                      <td style={{ padding: '9px 16px', fontWeight: 500, color: T.textMid }}>
                        {e.user}
                      </td>
        ...
        {(settingsTab === 'account' || settingsTab === 'api') && (
          ...
          >
            <Empty
              message={`${settingsTab === 'account' ? 'Account' : 'API key'} management coming soon`}
            />
          </div>
        )}
      </div>
      ...
      {done ? (
        <div style={{ textAlign: 'center', padding: '24px 0' }}>
          ...
          <div style={{ fontSize: 13, color: T.textSoft, marginBottom: 20 }}>
            {files.length} file{files.length !== 1 ? 's' : ''} queued for analysis. You'll be
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              padding: '32px 20px',
              textAlign: 'center',
              background: dragging ? '#eff6ff' : T.bg,
              cursor: 'pointer',
    ...
    <Modal title="Generate Due Diligence Report" onClose={onClose} width={500}>
      {done ? (
        <div style={{ textAlign: 'center', padding: '20px 0' }}>
          ...
          <div style={{ fontSize: 13, color: T.textSoft, marginBottom: 20 }}>
            Your {format.toUpperCase()} report has been generated.
          </div>
