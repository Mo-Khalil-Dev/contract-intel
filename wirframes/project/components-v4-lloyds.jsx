...
function HorseMark({ size = 28, color = '#fff' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <path
        d="M22 4c-1 0-2 .5-2.5 1.2L18 7l-1.5-.5C15 6 13.5 6 12 6.5c-1.5.5-2.5 1.5-3 3l-.5 2H7l-1 1v2l1 .5-.5 2L5 17v2l1.5 1L7 22l1 .5v3.5h2V23l.5-1h5l.5 1v2.5h2V22l1-1 1 .5 1-3.5 1.5-1.5.5-2.5V12l1-1.5V8.5L22 4z"
        fill={color}
      />
        ...
        {links.map((l) => (
          <button
            ...
            style={{
              ...
              borderBottom:
                active === l.id ? '2px solid rgba(255,255,255,0.8)' : '2px solid transparent',
            ...
            onMouseEnter={(e) => {
              if (active !== l.id) {
                ...
                e.currentTarget.style.backgroundColor = W.navBg2 + '99';
              }
            }}
            onMouseLeave={(e) => {
              if (active !== l.id) {
...
function RiskBar({ score }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
      <div
        style={{ width: 60, height: 5, background: W.border, borderRadius: 2, overflow: 'hidden' }}
      >
        <div
          style={{
            width: `${score * 10}%`,
