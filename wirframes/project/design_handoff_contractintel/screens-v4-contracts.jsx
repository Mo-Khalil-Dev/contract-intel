    ...
    >
      ...
      <div style={{ padding: '20px 28px' }}>
        ...
        >
              ...
              {paged.map((c, i) => (
                <tr
                  ...
                  style={{
                    ...
                    background: i % 2 === 1 ? W.bg : W.surface,
                  }}
                  onMouseEnter={(e) => {
                    if (c.status === 'complete') e.currentTarget.style.background = W.accentBg;
                  }}
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.background = i % 2 === 1 ? W.bg : W.surface)
                  }
                >
                  ...
                  <td style={{ padding: '10px 14px' }}>
                    {c.status === 'complete' ? (
                      ...
                      <span style={{ color: W.textMute, fontSize: 12 }}>—</span>
                    )}
                  </td>
                  <td style={{ padding: '10px 14px' }}>
                    {c.status === 'complete' ? (
                  ...
                  <td
                    style={{ padding: '10px 14px', color: W.textMid, fontSize: 12, maxWidth: 160 }}
                  >
                    <div
          ...
          {filtered.length === 0 && (
            <div style={{ padding: '48px', textAlign: 'center', color: W.textMute, fontSize: 13 }}>
            ...
            {Array.from({ length: pages }, (_, i) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 4,
                  border: `1px solid ${W.border}`,
                  background: page === i + 1 ? W.accent : W.surface,
                  color: page === i + 1 ? '#fff' : W.textMid,
                  cursor: 'pointer',
                  fontSize: 12,
                  fontWeight: 600,
                }}
    ...
    >
      ...
      >
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 6 }}>
          {prev && (
            <WBtn small variant="secondary" onClick={() => onNav(prev.id)}>
              ← Prev
            </WBtn>
          )}
          {next && (
            <WBtn small variant="secondary" onClick={() => onNav(next.id)}>
              Next →
            </WBtn>
          )}
          <WBtn small variant="secondary">
            Export
          </WBtn>
          <WBtn small variant="success">
            Approve
          </WBtn>
        </div>
      </div>
              ...
              <div style={{ maxWidth: 580 }}>
                {[
                  ...
                  <div key={sec.title} style={{ marginBottom: 24 }}>
                    ...
                    {sec.rows.map(([k, v]) => (
                      ...
                      >
                        <span
                          style={{ width: 170, flexShrink: 0, fontSize: 12, color: W.textSoft }}
                        >
                          {k}
                        </span>
                        <span style={{ fontSize: 12, fontWeight: 500, color: W.text }}>
                          {v || '—'}
                        </span>
                      </div>
                    ))}
                ...
                <div>
                  ...
                  {notes.map((n) => (
                    <div
                      key={n.id}
                      style={{ padding: '10px 0', borderBottom: `1px solid ${W.border}` }}
                    >
                      <div style={{ fontSize: 11, color: W.textSoft, marginBottom: 4 }}>
                        <strong style={{ color: W.textMid }}>{n.author}</strong> · {n.date}
                        {n.resolved && (
                          <span style={{ color: W.green, marginLeft: 8 }}>✓ Resolved</span>
                        )}
                      </div>
                      <div style={{ fontSize: 13, color: W.textMid, lineHeight: 1.5 }}>
                        {n.text}
                      </div>
                      {!n.resolved && (
                        <button
            ...
            {tab === 'risks' && (
              <div style={{ maxWidth: 680 }}>
                ...
                >
                  ...
                  flags · <span style={{ color: W.red }}>{c.flags.red} high</span> ·{' '}
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          ></span>
                          <span style={{ flex: 1, fontSize: 13, fontWeight: 600, color: W.text }}>
                            {f.title}
                          </span>
                          {isResolved && (
                          ...
                          <span style={{ fontSize: 11, color: W.textMute }}>
                            {isExpanded ? '▲' : '▼'}
                          </span>
                        </div>
                        {isExpanded && (
                          <div style={{ padding: '0 0 14px 17px' }}>
                            ...
                            >
                              <span style={{ fontWeight: 600, color: W.accent }}>
                                Recommendation:{' '}
                              </span>
                              {f.recommendation}
                            </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <strong style={{ color: W.orange }}>7. LIABILITY</strong>
                      <br />
                      <span style={{ background: '#fde68a', padding: '1px 2px', borderRadius: 2 }}>
                    ...
                    >
                      <strong style={{ color: W.red }}>10. INDEMNIFICATION</strong>
                      <br />
                      <span style={{ background: '#fca5a5', padding: '1px 2px', borderRadius: 2 }}>
                        Buyer shall indemnify Vendor for any IP infringement. Vendor indemnifies
                        Buyer only for gross negligence…
                      </span>
                    </div>
                    <p style={{ marginTop: 12, color: '#9ca3af', fontStyle: 'italic' }}>
                      [Pages 3–8 continue…]
                    </p>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <span style={{ fontSize: 11, color: W.textSoft, padding: '4px 8px' }}>
                      Page 1 of 8
                    </span>
                    <WBtn small variant="secondary">
                      Next →
                ...
                >
                  ...
                  <div style={{ fontSize: 13, fontWeight: 600, color: W.text, marginBottom: 8 }}>
                    §7.2 — Liability
                  </div>
                  <div
                    style={{
                  ...
                  <div style={{ fontSize: 11, fontWeight: 700, color: W.red, marginBottom: 8 }}>
                    ● Unlimited Liability
                  </div>
                  <div
                    style={{
                  ...
                  <p
                    style={{ fontSize: 11, color: W.textMid, margin: '0 0 12px', lineHeight: 1.6 }}
                  >
              ...
              <div style={{ maxWidth: 580 }}>
                {[
                  ...
                  },
                  {
                    ...
                    detail: `Risk score ${c.riskScore}/10 · ${c.riskFlags.length} flags`,
                    color: W.green,
                  },
                  {
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 11, color: W.textSoft, marginBottom: 2 }}>
                        {e.user}
                      </div>
        ...
        >
          ...
          <div
            style={{
              marginBottom: 20,
              padding: '14px',
              background: wRiskBg(c.riskScore),
              border: `1px solid ${wRisk(c.riskScore)}33`,
              borderRadius: 6,
              textAlign: 'center',
            }}
          >
            ...
            >
              {wRiskLabel(c.riskScore)} Risk
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', gap: 12, marginTop: 10 }}>
              {[
                { n: c.flags.red, c: W.red, l: 'High' },
                { n: c.flags.orange, c: W.orange, l: 'Med' },
                { n: c.flags.green, c: W.green, l: 'OK' },
              ].map((f) => (
          ...
          {[
            ...
            >
              ...
              <span style={{ fontSize: 11, fontWeight: 500, color: W.text, textAlign: 'right' }}>
                {row.value}
              </span>
            </div>
          ))}
