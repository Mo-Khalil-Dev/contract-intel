  ...
  const plans = [
    {
      name: 'FREE',
      price: '£0',
      features: ['5 analyses / month', 'Basic risk flags', 'PDF export'],
    },
    {
      name: 'PRO',
      price: '£20',
    ...
    },
    {
      ...
      price: '£100',
      period: '/mo',
      features: ['500 analyses / month', 'Unlimited seats', 'Bulk upload + API', 'Templates'],
    },
  ];
    ...
    <div style={{ flex: 1, background: T.bg, overflow: 'auto', fontFamily: MONO }}>
      ...
      >
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          >
            Upload any contract. Instant plain-English analysis — risks flagged, terms extracted,
            negotiation language ready to copy.
          </p>

          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', alignItems: 'center' }}>
            <Btn size="lg" onClick={() => onNav('upload')}>
              RUN ANALYSIS
            </Btn>
            <Btn size="lg" variant="secondary" onClick={() => onNav('results')}>
              VIEW SAMPLE REPORT
            </Btn>
          </div>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 0 }}>
          {steps.map((s, i) => (
            ...
            >
              <div style={{ fontSize: 18, color: T.amber, marginBottom: 8, lineHeight: 1 }}>
                {s.n}
              </div>
              <div style={{ fontSize: 11, color: T.ink, marginBottom: 5, letterSpacing: '0.06em' }}>
                {s.label}
              </div>
      ...
      >
        <div style={{ maxWidth: 760, margin: '0 auto', padding: '32px 24px' }}>
          ...
          >
            COMMON RISK FLAGS — LIVE DATABASE SAMPLE
          </div>
          <div
            style={{
              display: 'grid',
          ...
          >
            {risks.map((r, i) => (
              ...
              >
                <span style={{ fontSize: 9, color: T.inkMute, fontFamily: MONO, minWidth: 50 }}>
                  {r.code}
                </span>
                <span
                  style={{
          ...
          {plans.map((p, i) => (
            ...
            >
              <div
                style={{
                  fontSize: 9,
                  color: p.highlight ? T.amber : T.inkMute,
...
function UploadScreen({ onBack, onDone, uploadStyle }) {
  ...
  return (
    <PageShell
      title="UPLOAD"
      subtitle="PDF · DOCX · PPTX — max 50MB each · up to 20 files"
      actions={
      ...
      <div style={{ maxWidth: 580, margin: '32px auto', padding: '0 24px' }}>
        ...
        >
          <div
            style={{
              fontSize: 24,
              color: dragging ? T.amber : T.inkMute,
              marginBottom: 12,
              fontFamily: MONO,
            }}
          >
          ...
          <div
            style={{ fontSize: 10, color: T.inkSoft, marginBottom: 14, letterSpacing: '0.04em' }}
          >
            or click to browse
          </div>
        ...
        {files.length > 0 && (
          <div style={{ border: `1px solid ${T.border}`, marginBottom: 12, background: T.surface }}>
            ...
            >
              <span style={{ fontSize: 10, color: T.amber, letterSpacing: '0.1em' }}>
            ...
            {files.map((f, i) => (
              ...
              >
                <span style={{ fontSize: 9, color: T.amber, minWidth: 20, fontFamily: MONO }}>
                ...
                {f.size > 0 && (
                  <span style={{ fontSize: 10, color: T.inkSoft, fontFamily: MONO, flexShrink: 0 }}>
                    {fmt(f.size)}
                  </span>
                )}
                <button
        ...
        >
          <input
            ...
            style={{ marginTop: 2, flexShrink: 0, accentColor: T.amber }}
          />
          <span>
            I understand ContractIntel uses Claude AI to analyze documents. Files are encrypted in
            transit and stored securely.{' '}
            <span style={{ color: T.amber, cursor: 'pointer', textDecoration: 'underline' }}>
              PRIVACY POLICY
            </span>
          </span>
        </label>
        ...
        <div style={{ marginTop: 16, display: 'flex', gap: 20, flexWrap: 'wrap' }}>
          {['END-TO-END ENCRYPTED', 'NEVER SHARED', 'DELETE ANYTIME'].map((r) => (
            <span
              key={r}
              style={{ fontSize: 9, color: T.inkMute, letterSpacing: '0.08em', fontFamily: MONO }}
            >
              + {r}
            </span>
          ))}
    ...
    >
      <div style={{ maxWidth: 500, width: '100%' }}>
        ...
        <div style={{ marginBottom: 24, paddingBottom: 12, borderBottom: `1px solid ${T.border}` }}>
          <div style={{ fontSize: 9, color: T.inkMute, letterSpacing: '0.14em', marginBottom: 6 }}>
            ANALYSIS ENGINE
          </div>
          ...
          {steps.map((s, i) => (
            ...
            >
              <span
                style={{
                  fontSize: 9,
                  color: i < stepIdx ? T.green : i === stepIdx ? T.amber : T.inkMute,
                  fontFamily: MONO,
                  minWidth: 32,
                  letterSpacing: '0.08em',
                }}
              ...
              <span
                style={{
                  fontSize: 11,
                  color: i === stepIdx ? T.ink : T.inkMid,
                  flex: 1,
                  fontFamily: MONO,
                }}
              >
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}>
          ...
          <div style={{ flex: 1, overflow: 'auto', padding: '20px 24px' }}>
              ...
              <div style={{ maxWidth: 560 }}>
                ...
                <div
                  style={{
                    ...
                    border: `1px solid ${T.riskBorder(c.riskScore)}`,
                    padding: '16px 20px',
                    marginBottom: 20,
                    display: 'flex',
                    justifyContent: 'space-between',
                ...
                >
                  <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
                      <span style={{ fontSize: 40, color: rc, fontFamily: MONO, lineHeight: 1 }}>
                        {c.riskScore.toFixed(1)}
                      </span>
                      <span style={{ fontSize: 11, color: rc, letterSpacing: '0.1em' }}>
                    ...
                    {notes.map((n, i) => (
                      ...
                      >
                        ...
                        >
                          ...
                          {n.resolved && (
                            <span
                              style={{ color: T.green, marginLeft: 10, letterSpacing: '0.08em' }}
                            >
                              ✓ RESOLVED
                            </span>
                          )}
            ...
            {tab === 'risks' && (
              <div style={{ maxWidth: 680 }}>
                ...
                >
                  <span>
                    <span style={{ color: T.ink }}>{visibleFlags.length}</span> TOTAL
                  </span>
                      ...
                      >
                        <div
                          style={{
                            ...
                            padding: '10px 14px',
                            cursor: 'pointer',
                            background: isExpanded ? T.surfaceAlt : 'transparent',
                          }}
                          onClick={() => setExpandedFlag(isExpanded ? null : f.id)}
                        >
                          <SevTag severity={f.severity} />
                          <span
                            style={{ flex: 1, fontSize: 11, color: T.ink, letterSpacing: '0.02em' }}
                          >
                            {f.title}
                          </span>
                          {isResolved && (
                          ...
                          <span style={{ fontSize: 9, color: T.inkMute, letterSpacing: '0.04em' }}>
                            §{f.section}
                          </span>
                          <span style={{ color: T.inkMute, fontSize: 10 }}>
                            {isExpanded ? '▲' : '▼'}
                          </span>
                        </div>
                        {isExpanded && (
                          ...
                          >
                            ...
                            >
                              <span
                                style={{ color: T.amber, letterSpacing: '0.06em', fontSize: 9 }}
                              >
                                RECOMMENDATION:{' '}
                              </span>
                              {f.recommendation}
            ...
            {tab === 'document' && (
              ...
              >
                <div style={{ border: `1px solid ${T.border}`, background: T.surface }}>
                  ...
                  >
                    <span style={{ fontSize: 10, color: T.inkSoft, letterSpacing: '0.04em' }}>
                      {c.name}
                    </span>
                  ...
                  >
                    ...
                    <p>
                      ...
                      <span style={{ color: T.amber }}>{c.effectiveDate}</span>, between{' '}
                      <span style={{ color: T.ink }}>{c.parties[0]}</span> ("Vendor") and{' '}
                      <span style={{ color: T.ink }}>{c.parties[1]}</span> ("Buyer").
                    </p>
                    <p style={{ marginTop: 14 }}>
                      5. PAYMENT — Buyer agrees to pay {c.paymentAmount} on a {c.paymentSchedule}{' '}
                      basis.
                    </p>
                    <div
                      style={{
                    ...
                    >
                      <span style={{ color: T.orange }}>7. LIABILITY</span>
                      <br />
                      <span style={{ background: T.orangeDim, color: T.inkMid }}>
                    ...
                    >
                      <span style={{ color: T.red }}>10. INDEMNIFICATION</span>
                      <br />
                    ...
                    <p
                      style={{ marginTop: 14, color: T.inkMute, fontStyle: 'italic', fontSize: 10 }}
                    >
                      [Pages 3–8 continue…]
                    </p>
                  </div>
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 11, color: T.ink, marginBottom: 8, letterSpacing: '0.04em' }}
                  >
                    §7.2 — LIABILITY
                  </div>
                  <div
                  ...
                  <p style={{ fontSize: 10, color: T.inkMid, margin: '0 0 12px', lineHeight: 1.7 }}>
              ...
              <div style={{ maxWidth: 560 }}>
                {[
                  ...
                  },
                  {
                    ...
                    detail: `RISK ${c.riskScore}/10 · ${c.riskFlags.length} FLAGS`,
                    color: T.green,
                  },
                  {
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        ...
                        />
                        <span style={{ fontSize: 10, color: T.ink, letterSpacing: '0.06em' }}>
                          {e.action}
                        </span>
                        <span style={{ fontSize: 9, color: T.inkSoft, marginLeft: 4 }}>
                          {e.user}
                        </span>
                      </div>
                      <div style={{ fontSize: 10, color: T.inkSoft, paddingLeft: 13 }}>
                        {e.detail}
                      </div>
                    </div>
                  </div>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 36, color: T.riskColor(c.riskScore), fontFamily: MONO }}>
              {c.riskScore.toFixed(1)}
            </div>
            <div
              style={{
          ...
          {[
            ...
            >
              <span
                style={{ fontSize: 9, color: T.inkSoft, flexShrink: 0, letterSpacing: '0.06em' }}
              >
                {row.label}
              </span>
