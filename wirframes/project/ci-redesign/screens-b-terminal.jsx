...
function DeepDiveScreen({ contractId, flagId, onBack }) {
  ...
  return (
    <PageShell
      title="DEEP DIVE"
      subtitle={`${c.name} · §${f.section} · PG ${f.page}`}
      actions={
    ...
    >
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '24px' }}>
        ...
        <div
          style={{
            background: T.sevBg(f.severity),
            border: `1px solid ${T.sevBorder(f.severity)}`,
            padding: '14px 18px',
            marginBottom: 24,
          }}
        >
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            ...
            <span style={{ fontSize: 13, color: T.ink, fontFamily: MONO, letterSpacing: '0.02em' }}>
              {f.title}
            </span>
          </div>
          <div
          ...
          >
            STATUS:{' '}
            {f.status === 'open' ? (
              <span style={{ color: T.orange }}>OPEN — ACTION REQUIRED</span>
            ) : (
              <span style={{ color: T.green }}>ACCEPTED</span>
            )}
          </div>
        </div>
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          <div
            style={{ border: `1px solid ${T.border}`, background: T.surface, padding: '14px 18px' }}
          >
            <p
              style={{
                margin: 0,
        ...
        <div style={{ marginBottom: 22 }}>
          <SectionLabel>
            THE ACTUAL CLAUSE — PG {f.page}, §{f.section}
          </SectionLabel>
          <div
            style={{
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          >
            ...
            >
              If this clause stands as-is and a dispute arises, you may have limited or no legal
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          <div style={{ border: `1px solid ${T.border}`, background: T.surface }}>
            {standards.map((s, i) => (
              ...
              >
                <span
                  style={{ color: T.green, fontSize: 10, flexShrink: 0, letterSpacing: '0.06em' }}
                >
                  +
                </span>
...
function CompareScreen({ onSelectContract }) {
  ...
  return (
    <PageShell
      title="COMPARE"
      subtitle="Side-by-side term analysis"
      actions={
      ...
      <div style={{ padding: '16px 24px' }}>
        ...
        >
          {[
            ...
            <div key={i}>
              <div
                style={{ fontSize: 9, color: T.inkMute, letterSpacing: '0.14em', marginBottom: 5 }}
              >
                {sel.label}
              </div>
              <select
          ...
          >
            ...
            <span style={{ fontSize: 11, color: T.green, fontFamily: MONO }}>
              {overallWinner === 'A'
                ? cA.name.replace(/\.[^.]+$/, '')
                : cB.name.replace(/\.[^.]+$/, '')}{' '}
              — better terms ({overallWinner === 'A' ? winsA : winsB} vs{' '}
              {overallWinner === 'A' ? winsB : winsA} categories)
            </span>
          </div>
        )}
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: cell.w ? T.greenDim : 'transparent',
                      display: 'flex',
                      alignItems: 'center',
                  ...
                  >
                    ...
                    {cell.w && (
                      <span style={{ fontSize: 9, color: T.green, letterSpacing: '0.08em' }}>
                        ✓
                      </span>
                    )}
                  </div>
      ...
      >
        {[
          ...
          { label: 'CRITICAL FLAGS', value: totalRed, color: T.red },
          {
            ...
            color: urgentRenewals > 0 ? T.orange : T.green,
          },
        ].map((k, i) => (
          <div
            key={k.label}
          ...
          >
            <div
              style={{ fontSize: 9, color: T.inkMute, letterSpacing: '0.12em', marginBottom: 4 }}
            >
              {k.label}
            </div>
          ...
          >
            {filtered.map((c) => (
              <div
                ...
                onMouseEnter={(e) => {
                  if (c.status === 'complete') e.currentTarget.style.borderColor = T.amber;
                }}
              ...
              >
                ...
                >
                  ...
                  {c.status === 'complete' ? (
                    <RiskCode score={c.riskScore} />
                  ) : (
                    <span style={{ fontSize: 10, color: T.amber, fontFamily: MONO }}>
                      {c.progress || 0}%
                    </span>
                  )}
                </div>
                ...
                <div style={{ fontSize: 10, color: T.inkSoft, marginBottom: 10, fontFamily: MONO }}>
                  {c.parties[0]}
                </div>
                {c.status === 'complete' && (
                  <div
                  ...
                  >
                    ...
                    <span style={{ fontSize: 10, color: T.inkMute, fontFamily: MONO }}>
                      {c.terminationDate || '—'}
                    </span>
                  </div>
                )}
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11 }}>
              <thead>
                <tr style={{ background: T.surfaceAlt, borderBottom: `1px solid ${T.border}` }}>
                  {['CONTRACT', 'TYPE', 'RISK', 'FLAGS', 'COUNTERPARTY', 'EXPIRY', 'STATUS'].map(
                    (h) => (
                      <th
                        key={h}
                        style={{
              ...
              <tbody>
                {filtered.map((c, i) => (
                  <tr
                    ...
                    onMouseEnter={(e) => {
                      if (c.status === 'complete') e.currentTarget.style.background = T.surfaceAlt;
                    }}
            ...
            {filtered.map((c) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 9, color: T.inkSoft, fontFamily: MONO }}>
                    {c.parties[0]}
                  </div>
                </div>
                {c.status === 'complete' ? (
    ...
    >
      <div style={{ maxWidth: 560, margin: '0 auto', padding: '24px' }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          >
            <div
              style={{ fontSize: 10, color: T.inkMid, marginBottom: 10, letterSpacing: '0.06em' }}
            >
              SEND VIA EMAIL
            </div>
            <div style={{ display: 'flex', gap: 8 }}>
            ...
            <div style={{ marginTop: 6, fontSize: 9, color: T.inkMute, letterSpacing: '0.06em' }}>
              RECIPIENT GETS VIEW-ONLY LINK — NO ACCOUNT NEEDED
            </div>
          </div>
          ...
          >
            ...
            >
              <span style={{ fontSize: 10, color: T.inkMid, letterSpacing: '0.06em' }}>
                SHAREABLE LINK
              </span>
              <Btn
                size="sm"
            ...
            {formats.map((f, i) => (
              <div
                ...
                style={{
                  ...
                  alignItems: 'center',
                  padding: '12px 18px',
                  borderBottom: i < formats.length - 1 ? `1px solid ${T.border}` : 'none',
                  gap: 16,
                }}
              >
                ...
                .map((r) => (
                  <tr
                    ...
                    style={{
                      borderBottom: `1px solid ${T.border}`,
                      cursor: 'pointer',
                      background: selected === r.id ? T.surfaceAlt : '',
                    }}
                    onMouseEnter={(e) => {
                      if (selected !== r.id) e.currentTarget.style.background = T.surfaceAlt;
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    <td
                      style={{
                        padding: '9px 14px',
                        borderLeft: `2px solid ${rc(r)}`,
                        fontFamily: MONO,
                        fontSize: 11,
                        color: T.ink,
                      }}
                    >
                      {r.name.replace(/\.[^.]+$/, '').slice(0, 26)}
                    </td>
                    <td
                      style={{
                        padding: '9px 14px',
        ...
        <div style={{ padding: '20px 0', maxWidth: 820 }}>
                      ...
                      <tr key={m.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                        <td style={{ padding: '10px 14px' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                            ...
                            <div>
                              <div style={{ color: T.ink, fontFamily: MONO, fontSize: 11 }}>
                                {m.name}
                              </div>
                              <div style={{ fontSize: 10, color: T.inkSoft, fontFamily: MONO }}>
                                {m.email}
                              </div>
                            </div>
                          </div>
          ...
          {tab === 'billing' && (
            <div style={{ maxWidth: 400 }}>
              <div
                style={{ border: `1px solid ${T.border}`, background: T.surface, padding: '20px' }}
              >
                <div
                  style={{
                    display: 'flex',
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 10, color: T.inkSoft, fontFamily: MONO, marginTop: 2 }}>
          ...
          {tab === 'audit' && (
            <div
              style={{ fontSize: 10, color: T.inkMute, fontFamily: MONO, letterSpacing: '0.08em' }}
            >
              FULL AUDIT LOG AVAILABLE IN V1 RELEASE
            </div>
          )}
        </div>
      </div>
