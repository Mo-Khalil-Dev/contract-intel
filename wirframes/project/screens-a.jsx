...
function HomeScreen({ onNav }) {
  ...
  const recent = [...complete]
    ...
    .slice(0, 4);
  const urgent = RENEWALS
    ? [...RENEWALS].sort((a, b) => a.daysRemaining - b.daysRemaining).slice(0, 3)
    : [];
  ...
  return (
    <div style={{ flex: 1, background: T.bg, overflow: 'auto' }}>
      ...
      <div style={{ background: T.surface, borderBottom: `1px solid ${T.border}` }}>
        <div
          className="ci-pad-32 ci-home-banner"
          style={{
            maxWidth: 1120,
            margin: '0 auto',
            padding: '14px 32px',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <rect x="1" y="1" width="12" height="12" rx="2" fill={T.ink} />
              <path
                d="M4 10V4l3 4 3-4v6"
                stroke="#fff"
                strokeWidth="1.5"
      ...
      {/* Greeting + KPIs */}
      <div
        className="ci-pad-32 ci-pad-y-lg"
        style={{ maxWidth: 1120, margin: '0 auto', padding: '36px 32px 24px' }}
      >
        <div
          style={{
            display: 'flex',
        ...
        >
          <div>
            ...
            >
              You have <strong style={{ color: T.red }}>{totalRed} critical flags</strong> across
              your portfolio and{' '}
              <strong
                style={{ color: urgent[0] && urgent[0].daysRemaining < 60 ? T.orange : T.ink }}
              >
                {urgent.filter((r) => r.daysRemaining < 60).length} urgent renewals
              </strong>{' '}
              in the next 60 days.
            </p>
          </div>
          <div className="ci-actions-wrap" style={{ display: 'flex', gap: 10 }}>
            <Btn variant="secondary" onClick={() => onNav('portfolio')}>
              View all contracts
            </Btn>
          ...
          {[
            {
              ...
              sub: `${inProgress.length} in review`,
              color: T.ink,
            },
            {
              ...
              value: avgRisk,
              sub:
                parseFloat(avgRisk) >= 7
                  ? 'High — review needed'
                  : parseFloat(avgRisk) >= 4
                    ? 'Medium'
                    : 'Low',
            ...
            },
            {
              ...
              value: urgent.filter((r) => r.daysRemaining < 60).length,
              sub: urgent[0] ? `Next: ${urgent[0].renewalDate}` : '—',
              color: T.orange,
            },
          ].map((k) => (
            <div
        ...
        {/* Where to start */}
        <div
          className="ci-stack-md"
          style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 16, marginBottom: 36 }}
        >
          {/* Primary CTA: upload */}
          <div
          ...
          >
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                >
                  PDF, DOCX · up to 50 MB · 60s analysis
                </span>
              </div>
            </div>
          </div>
            ...
            >
              <div>
                ...
                <div
                  style={{ fontSize: 12, color: T.inkSoft, fontFamily: "'DM Sans', sans-serif" }}
                >
                  {urgent.filter((r) => r.daysRemaining < 60).length} need attention this quarter
                </div>
              </div>
              <span style={{ color: T.inkMute, fontSize: 18 }}>→</span>
            </div>
        ...
        <div
          className="ci-stack-md"
          style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 16, marginBottom: 36 }}
        >
          {/* Recent contracts */}
          <div
            style={{
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Most recently uploaded or reviewed
                </div>
              </div>
              <button
                onClick={() => onNav('portfolio')}
            ...
            {recent.map((c, i) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    {c.parties[0]} · uploaded {c.uploadDate}
                  </div>
                </div>
              ...
              urgent.map((r, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      padding: '12px 18px',
                      borderBottom: i < urgent.length - 1 ? `1px solid ${T.border}` : 'none',
                      cursor: 'pointer',
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {r.renewalDate} · {r.noticePeriod} notice
                      </span>
                      <span
                        style={{
                          fontSize: 12,
      ...
      >
        <div
          className="ci-pad-32"
          style={{ maxWidth: 1120, margin: '0 auto', padding: '40px 32px' }}
        >
          <div
            style={{
              display: 'flex',
          ...
          >
            <div>
              ...
              >
                How contracts move through Legal Ops
              </h2>
              <p
                style={{
                  margin: '6px 0 0',
          ...
          >
            {steps.map((s, i) => (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  <div
                    style={{
                      ...
                      border: `1px solid ${i === 0 ? T.blue : T.borderMid}`,
                      display: 'flex',
                      alignItems: 'center',
                ...
                >
                  <span style={{ color: T.inkMute, marginRight: 6 }}>Owner:</span>
                  {s.who}
                </div>
              </div>
            ))}
      ...
      <div
        className="ci-pad-32"
        style={{ maxWidth: 1120, margin: '0 auto', padding: '40px 32px 56px' }}
      >
        <div
          className="ci-stack-md"
        ...
        >
          <div>
            ...
            >
              What every contract is checked against
            </h2>
            <p
              style={{
                margin: '0 0 16px',
            ...
            >
              ...
              outside these lines is flagged for review — no exceptions without sign-off from Head
              of Legal.
            </p>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    background: T.surface,
                    border: `1px solid ${T.border}`,
                    borderLeft: `3px solid ${T.sevColor(ex.sev)}`,
                    borderRadius: 6,
                    padding: '9px 14px',
                  }}
                >
      ...
      <div className="ci-pad-32" style={{ maxWidth: 600, margin: '40px auto', padding: '0 32px' }}>
        ...
        <div
          ...
          style={{
            ...
            borderRadius: 12,
            padding: isSimple ? '60px 32px' : '48px 32px',
        ...
        >
          <div
            style={{
              ...
              height: 48,
              borderRadius: 12,
              background: dragging ? T.blue : T.bgAlt,
              border: `1px solid ${dragging ? T.blue : T.border}`,
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              margin: '0 auto 16px',
            ...
            {files.map((f) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {f.size > 0 && (
                    <div
                      style={{ fontSize: 11, color: T.inkMute, fontFamily: "'DM Mono', monospace" }}
                    >
                      {fmt(f.size)}
                    </div>
                  )}
        ...
        >
          ...
          />
          <span>
            I understand that ContractIntel uses Claude AI to analyze these documents. Files are
        ...
        >
          {['End-to-end encrypted', 'Never shared with third parties', 'Delete anytime'].map(
            (r) => (
              <span
                key={r}
                style={{
      ...
      <div style={{ maxWidth: 480, width: '100%', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', width: 80, height: 80, margin: '0 auto 28px' }}>
          <svg
            ...
            height="80"
            viewBox="0 0 80 80"
            style={{ animation: 'ciSpin 1.8s linear infinite' }}
          >
            ...
            >
              <div
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  background: i < stepIdx ? T.green : i === stepIdx ? T.blue : T.border,
                }}
              >
                {i < stepIdx ? (
              ...
              <div style={{ flex: 1 }}>
                <div
                  style={{
                    ...
                    color: i <= stepIdx ? T.ink : T.inkMute,
                    fontFamily: "'DM Sans', sans-serif",
                  }}
                >
                  {s.label}
...
function ResultsScreen({ contractId, onBack, onDeepDive, onExport, onNav, riskStyle }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="ci-results-row"
        style={{ display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}
      >
        {/* Left: main content */}
        <div
          className="ci-results-main"
          style={{
            flex: 1,
            display: 'flex',
            flexDirection: 'column',
          ...
          <div className="ci-pad-32" style={{ flex: 1, overflow: 'auto', padding: '28px 32px' }}>
            ...
            {tab === 'overview' && (
              <div style={{ maxWidth: 560 }}>
                {/* Quick snapshot card */}
                <div
                  className="ci-risk-snap"
                  style={{
                    background: T.riskBg(c.riskScore),
                    border: `1px solid ${T.riskColor(c.riskScore)}33`,
                    borderRadius: 10,
                    padding: '20px 24px',
                    marginBottom: 24,
                    display: 'flex',
                ...
                >
                  <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
                      <span
                        className="ci-risk-mega"
                        style={{
                          fontSize: 40,
                          fontWeight: 900,
                          color: T.riskColor(c.riskScore),
                          fontFamily: "'DM Mono', monospace",
                          lineHeight: 1,
                        }}
                      >
                      ...
                      >
                        {T.riskLabel(c.riskScore)}
                      </span>
                    </div>
                  </div>
                  <div style={{ display: 'flex', gap: 16 }}>
                    {[
                      { n: c.flags.red, c: T.red, l: 'Critical' },
                      { n: c.flags.orange, c: T.orange, l: 'Caution' },
                      { n: c.flags.green, c: T.green, l: 'Info' },
                    ].map((f) => (
                      ...
                      {sec.rows.map(([k, v], i) => (
                        <div
                          ...
                          style={{
                            ...
                            padding: '10px 16px',
                            borderBottom:
                              i < sec.rows.length - 1 ? `1px solid ${T.border}` : 'none',
                          }}
                        >
                          <span
                            style={{
                    ...
                    {notes.map((n, i) => (
                      ...
                      >
                        ...
                        >
                          ...
                          {n.resolved && (
                            <span style={{ color: T.green, marginLeft: 8, fontWeight: 600 }}>
                              ✓ Resolved
                            </span>
                          )}
                        </div>
            ...
            {tab === 'risks' && (
              <div style={{ maxWidth: 660 }}>
                ...
                >
                  <span>
                    <strong style={{ color: T.ink }}>{visibleFlags.length}</strong> total
                  </span>
                    ...
                    {visibleFlags.map((f, i) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            borderBottom:
                              i < visibleFlags.length - 1 ? `1px solid ${T.border}` : 'none',
                        ...
                        >
                          ...
                          >
                            ...
                            {isResolved && (
                              <Badge label="Resolved" color={T.green} bg={T.greenBg} />
                            )}
                            <span
                              style={{
                                fontSize: 11,
                          ...
                          {isExpanded && (
                            <div style={{ padding: '0 16px 16px 36px' }}>
                              ...
                              <div style={{ display: 'flex', gap: 8 }}>
                                ...
                                <Btn size="sm" variant="secondary" onClick={() => onDeepDive(f.id)}>
                                  Deep dive →
                                </Btn>
                              </div>
                            </div>
                    ...
                    {visibleFlags.map((f) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <span style={{ fontWeight: 600, color: T.blue }}>Recommendation: </span>
                            {f.recommendation}
                          </div>
                          <div style={{ display: 'flex', gap: 8 }}>
                            <Btn
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <p>
                      This Agreement is entered into as of <strong>{c.effectiveDate}</strong>,
                      between <strong>{c.parties[0]}</strong> ("Vendor") and{' '}
                      <strong>{c.parties[1]}</strong> ("Buyer").
                    </p>
                    <p style={{ marginTop: 16 }}>
                      <strong>5. PAYMENT</strong>
                      <br />
                      Buyer agrees to pay {c.paymentAmount} on a {c.paymentSchedule} basis under
                      terms of {c.paymentTerms}.
                    </p>
                    <div
                      style={{
                        marginTop: 16,
                    ...
                    >
                      <strong style={{ color: T.orange }}>7. LIABILITY</strong>
                      <br />
                      <span style={{ background: '#fde68a', padding: '1px 3px', borderRadius: 2 }}>
                    ...
                    >
                      <strong style={{ color: T.red }}>10. INDEMNIFICATION</strong>
                      <br />
                      <span style={{ background: '#fca5a5', padding: '1px 3px', borderRadius: 2 }}>
                        Buyer shall indemnify Vendor for any IP infringement…
                      </span>
                    </div>
                    <p style={{ marginTop: 16, color: '#9ca3af', fontStyle: 'italic' }}>
                      [Pages 3–8 continue…]
                    </p>
                  </div>
                  <div
                ...
                >
                  ...
                  >
                    "Vendor's liability shall not be limited in any manner whatsoever…"
                  </div>
                  ...
                  <Btn size="sm" variant="secondary" full>
              ...
              <div style={{ maxWidth: 560 }}>
                {[
                  ...
                  },
                  {
                    ...
                    user: 'Sarah Chen',
                    action: 'Note added',
                    detail: 'Check if liability cap is negotiable.',
                    color: T.inkSoft,
                  },
                  {
                    time: '2026-04-14 10:05',
                    user: 'Sarah Chen',
                    action: 'Risk flag reviewed',
        ...
        >
          ...
          <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Btn size="sm" variant="primary" full onClick={onExport}>
              Export PDF
            </Btn>
            <Btn size="sm" variant="secondary" full>
              Share with team
