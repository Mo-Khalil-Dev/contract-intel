            ...
            <tbody>
              {paged.map((c, i) => (
                <tr
                  ...
                  onMouseEnter={(e) => {
                    if (c.status === 'complete') e.currentTarget.style.background = '#eff6ff';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = i % 2 === 1 ? '#fbfcfd' : '#fff';
                  }}
                >
                  ...
                  <td
                    style={{ padding: '10px 14px', color: T.textMid, fontSize: 12, maxWidth: 160 }}
                  >
                    <div
            ...
            {Array.from({ length: totalPages }, (_, i) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 4,
                  border: `1px solid ${T.border}`,
                  background: page === i + 1 ? T.blue : '#fff',
                  color: page === i + 1 ? '#fff' : T.textMid,
                  cursor: 'pointer',
                  fontSize: 12,
                  fontWeight: 600,
                }}
...
function ContractDetailScreen({ contractId, onBack, onNav }) {
  ...
  function Field({ label, value, field }) {
    ...
    return (
      ...
      >
        <div style={{ width: 180, flexShrink: 0, fontSize: 12, color: T.textSoft, paddingTop: 2 }}>
          {label}
        </div>
        {isEditing ? (
          <div style={{ flex: 1, display: 'flex', gap: 6 }}>
            ...
            />
            <Btn small variant="primary" onClick={() => setEditField(null)}>
              Save
            </Btn>
            <Btn small variant="secondary" onClick={() => setEditField(null)}>
              Cancel
            </Btn>
          </div>
        ) : (
              ...
              <div style={{ marginBottom: 12 }}>
                {notes.map((n) => (
                  <div
                    ...
                    style={{
                      padding: '10px 12px',
                      background: n.resolved ? '#f8fafc' : T.yellowBg,
                  ...
                  >
                    <div style={{ fontSize: 11, color: T.textSoft, marginBottom: 4 }}>
                      ...
                      {n.resolved && (
                        <span style={{ color: T.green, marginLeft: 6 }}>✓ Resolved</span>
                      )}
                    </div>
              ...
              {['all', 'red', 'orange', 'green', 'resolved'].map((f) => (
                <button
                  ...
                  style={{
                    ...
                    color:
                      flagFilter === f ? (f === 'all' ? '#fff' : severityColor(f)) : T.textSoft,
                    cursor: 'pointer',
                    fontSize: 12,
                    fontWeight: 600,
            ...
            {visibleFlags.map((f) => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: T.surface,
                    border: `1px solid ${isResolved ? T.border : severityColor(f.severity) + '33'}`,
                ...
                >
                  ...
                  >
                    ...
                    {f.status === 'accepted' && (
                      <span style={{ fontSize: 11, color: T.textSoft }}>Accepted risk</span>
                    )}
        ...
        {tab === 'document' && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, maxWidth: 1000 }}>
            ...
            >
              ...
              >
                <div
                  style={{ fontWeight: 700, textAlign: 'center', marginBottom: 20, fontSize: 14 }}
                >
                  VENDOR AGREEMENT
                </div>
                <p>
                  This Agreement is entered into as of <strong>{c.effectiveDate}</strong>, between{' '}
                  <strong>{c.parties[0]}</strong> ("Vendor") and <strong>{c.parties[1]}</strong>{' '}
                  ("Buyer").
                </p>
                <p style={{ marginTop: 12 }}>
                  <strong>1. SERVICES</strong>
                  <br />
                  Vendor shall provide services as described in Exhibit A...
                </p>
                <p style={{ marginTop: 12 }}>
                ...
                >
                  ...
                  <span style={{ background: '#fde68a' }}>
                    ...
                    Buyer acknowledges that Vendor may face unlimited exposure under any
                    circumstances...
                  </span>
                </div>
                <div
                ...
                >
                  ...
                  <span style={{ background: '#fca5a5' }}>
                    ...
                    Vendor shall only indemnify Buyer for claims arising from Vendor's own gross
                    negligence...
                  </span>
                </div>
                <p style={{ marginTop: 12, color: '#94a3b8', fontStyle: 'italic' }}>
                  [Pages 3–8 continue…]
                </p>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: 12, color: T.textSoft, padding: '5px 8px' }}>
                  Page 1 of 8
                </span>
                <Btn small variant="secondary">
                  Next →
            ...
            >
              ...
              <div style={{ padding: 16 }}>
                ...
                >
                  "Vendor's liability hereunder shall not be limited in any manner whatsoever, and
                  Buyer acknowledges that Vendor may face unlimited exposure under any circumstances
                ...
                <div style={{ display: 'flex', gap: 6 }}>
                  ...
                  <Btn small variant="primary" onClick={() => setTab('risks')}>
                    View Flag →
                  </Btn>
                </div>
              </div>
              ...
              >
                <div style={{ fontSize: 11, color: T.textSoft, marginBottom: 6, fontWeight: 600 }}>
                  Legend
                </div>
                <div style={{ display: 'flex', gap: 12, fontSize: 11, color: T.textSoft }}>
                  <span>
                    <span style={{ color: T.red }}>■</span> High Risk
                  </span>
                  <span>
                    <span style={{ color: T.orange }}>■</span> Medium Risk
                  </span>
                  <span>
                    <span style={{ color: T.yellow }}>■</span> Info
                  </span>
                </div>
              </div>
            </div>
          ...
          <div style={{ maxWidth: 700 }}>
            {[
              ...
              },
              {
                ...
                detail: `Risk score: ${c.riskScore}/10 · ${totalFlags} flags identified`,
                icon: '◆',
                color: T.green,
              },
              {
