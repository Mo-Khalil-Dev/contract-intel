...
function TopNav({ screen, onNav }) {
  ...
  return (
    ...
    >
      <div
        className="ci-nav-pad"
        style={{ height: 56, display: 'flex', alignItems: 'center', padding: '0 32px', gap: 0 }}
      >
        {/* Logo */}
        <div
          onClick={() => onNav('home')}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
          ...
          >
            ...
            <span style={{ display: 'none' }} className="ci-nav-upload-icon">
              +
            </span>
          </Btn>
          <div
      ...
      {/* Mobile drawer */}
      <div
        className={`ci-nav-drawer${drawerOpen ? ' open' : ''}`}
        style={{
          background: T.nav,
