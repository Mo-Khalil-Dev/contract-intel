...
describe('WhereToStartSection', () => {
  ...
  describe('resume card with recent contract', () => {
    it('should render resume card when lastOpenedContract exists', () => {
      render(
        <WhereToStartSection
          lastOpenedContract={mockRecentContract}
          onUpload={jest.fn()}
        />
      );
  ...
  describe('sample card', () => {
    ...
    it('should render sample card description', () => {
      ...
      expect(
        screen.getByText(/Review a sample contract/)
      ).toBeInTheDocument();
    });
  ...
  describe('different contract types', () => {
    it('should display different contract types in resume card', () => {
      ...
      render(
        <WhereToStartSection
          lastOpenedContract={licenseContract}
          onUpload={jest.fn()}
        />
      );
    ...
    it('should display different risk scores in resume card', () => {
      ...
      render(
        <WhereToStartSection
          lastOpenedContract={highRiskContract}
          onUpload={jest.fn()}
        />
      );
  ...
  describe('edge cases', () => {
    ...
    it('should handle long contract names', () => {
      ...
      render(
        <WhereToStartSection
          lastOpenedContract={longNameContract}
          onUpload={jest.fn()}
        />
      );
      expect(
